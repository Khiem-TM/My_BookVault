...
/**
 * @deprecated This DTO is replaced by RentBookRequest and RentalResponse.
 * Use the new Request/Response pattern for all new development.
 * This class will be removed in version 3.0.
 * 
 * @see com.khiem.book.dto.request.RentBookRequest
 * @see com.khiem.book.dto.response.RentalResponse
 */
